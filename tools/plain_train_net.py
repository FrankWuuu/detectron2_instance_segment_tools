...
register_coco_instances("my_dataset_train", {}, "O2PR/train/annotations/train.json", "O2PR/train/images")
...
./plain_train_net.py \
  --config-file config/mask_rcnn_R_50_FPN_3x_tooth_ins.yaml \
  --num-gpus 1 SOLVER.IMS_PER_BATCH 2 SOLVER.BASE_LR 0.0025

# To evaluate a model's performance, use

./plain_train_net.py \
  --config-file config/mask_rcnn_R_50_FPN_3x_tooth_ins.yaml.yaml \
